<?php
/**
 * QRGenerator - php QR Code generator
 * config.php
 *
 ...
 * @category  PHP
 * @package   QRGenerator
 * @author    Uzair Ahmed <uzairtahir535@gmail.com>
 * @copyright 2023 - 2030
 * @link      http://qrcode.sparxbyte.com/
 */
$version = '5.3.5';

if (version_compare(phpversion(), '5.4', '<')) {
    exit("QRGenerator requires at least PHP version 5.4.");
}
